...
public class CalculatorServiceApplication {
	...
	//Проблемма с нахождение функций при имени func1, разделються на два элемента func и 1 | func_tree
	...
	//Доделать для других моделей своих функций
	//Перенести сервер для созданий своих функций на отдельный сервер
